...
class Unidad extends Resource
{
     ...
     * @var string
     */
    public static $model = \App\Models\Unidad::class;
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Text::make('Banner')->hideFromIndex(),
            Text::make('Imagen')->hideFromIndex(),
            Textarea::make('Descripción', 'descripcion')->hideFromIndex(),
            HasMany::make('Lineas'),
            HasMany::make('Valoragregado'),
        ];
    }
